...
<html>
    ...
    <body>
        <div class="banner">
            <div class="navbar">
                <img class="logo" src="logoParcel.png" action="mainPage.php"> 
                <ul class="menu">
  ...
  <div style="display: flex; justify-content: space-between; flex-wrap: wrap; max-width: 1200px; margin: 0 auto;">
    ...
    <div style="flex: 1; min-width: 200px; margin: 10px;">
      ...
      <ul style="list-style-type: none; padding: 10px; display: flex; gap: 10px;">
        <li><a href="#" style="color: white; text-decoration: none;"><img src="facebook.png" alt="Facebook" style="width: 24px;"></a></li>
        <li><a href="#" style="color: white; text-decoration: none;"><img src="twitter.png" alt="Twitter" style="width: 24px;"></a></li>
        <li><a href="#" style="color: white; text-decoration: none;"><img src="instagram.png" alt="Instagram" style="width: 24px;"></a></li>
        <li><a href="#" style="color: white; text-decoration: none;"><img src="linkedin.png" alt="LinkedIn" style="width: 24px;"></a></li>
      </ul>
    </div>
